...
const STEPS = [
  ...
  { id: 9, title: "Kleur Selectie (3)", component: "slide7" }, // Slide7 - Final Color Selection
...
export default function SalonForm() {
  ...
  const [formData, setFormData] = useState<FormData>({
    ...
    finalColorChoice: "", // Added for Slide7 validation
  })
  ...
  const updateFormData = (updates: Partial<FormData>) => {
    ...
    console.log("[v0] Form data after local update:", newFormData)
  }
  ...
  const handleSlide4SelectionChange = (variant: string | null) => {
    setSelectedVariant(variant)
    updateFormData({ styleVariant: variant || "" })
  }
  ...
  const hasSelection = () => {
    ...
    switch (currentStep) {
      ...
      case 7: // Slide5 - Elegant Variant 2
        const hasStyleVariant =
          formData.styleVariant !== "" && formData.styleVariant !== null && formData.styleVariant !== undefined
        console.log("[v0] Style variant check:", hasStyleVariant, "formData.styleVariant:", formData.styleVariant)
        return hasStyleVariant
      case 8: // Slide6 - Color Selection
        const hasColorScheme =
          formData.colorScheme !== "" && formData.colorScheme !== null && formData.colorScheme !== undefined
        console.log("[v0] Color scheme check:", hasColorScheme, "formData.colorScheme:", formData.colorScheme)
        return hasColorScheme
      case 9: // Slide7 - Final Color Selection
        const hasFinalColorChoice =
          formData.finalColorChoice !== "" &&
          formData.finalColorChoice !== null &&
          formData.finalColorChoice !== undefined
        console.log(
          "[v0] Final color choice check:",
          hasFinalColorChoice,
          "formData.finalColorChoice:",
          formData.finalColorChoice,
        )
        return hasFinalColorChoice
      case 10: // Slide8 - Color Palette
        const hasColorPalette =
          formData.colorPalette !== "" && formData.colorPalette !== null && formData.colorPalette !== undefined
        console.log("[v0] Color palette check:", hasColorPalette, "formData.colorPalette:", formData.colorPalette)
        console.log("[v0] Full formData for palette check:", JSON.stringify(formData, null, 2))
      ...
      case 6:
        return (
          <Slide4
            ...
            onSelectionChange={handleSlide4SelectionChange}
          />
        ) // Slide4
      case 7:
        return <Slide5 onNext={nextStep} onBack={prevStep} /> // Slide5
      case 8:
        return <Slide6 onNext={nextStep} onBack={prevStep} /> // Slide6
      case 9:
        return <Slide7 onNext={nextStep} onBack={prevStep} /> // Slide7
      case 10:
  ...
  return (
    <FormDataProvider formData={formData} updateFormData={updateFormData}>
