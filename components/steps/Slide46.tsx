...
export default function Slide46({ updateFormData, formData, onNext, onBack, goToStep }: StepProps) {
  return (
    <SlideContainer width="wide">
      <section>
        <h2 className={getTypographyClasses("title", { alignment: "left" })}>
          Placeholder - Slide 46
        </h2>

        <div className="max-w-[760px] space-y-4 mb-8">
          <p className={getTypographyClasses("paragraph", { alignment: "left" })}>
            Dit is een placeholder voor Slide 46 - Zonder claim pad.
          </p>
