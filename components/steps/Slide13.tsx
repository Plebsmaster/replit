...
export default function Slide13({ formData, updateFormData, onBack, onNext, selectedVariant: globalSelectedVariant, onSelectionChange, goToStep }: Props) {
  ...
  const answers = [
    { text: 'Uitlijning links', nextSlide: 'slide16', dbValue: 'Modern 2.1', key: "1", label: "Uitlijning links", imageSrc: "/img/slide13/variant1.jpg", alt: "Modern 2 Variant 1 - Left alignment" },
    { text: 'Uitlijning midden', nextSlide: 'slide16', dbValue: 'Modern 2.2', key: "2", label: "Uitlijning midden", imageSrc: "/img/slide13/variant2.jpg", alt: "Modern 2 Variant 2 - Center alignment" }
  ]
